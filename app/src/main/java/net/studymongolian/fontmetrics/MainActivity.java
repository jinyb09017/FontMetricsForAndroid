...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvSizeValue = (TextView) findViewById(R.id.tvSizeValue);
        tvLineValue = (TextView) findViewById(R.id.tvLineValue);
        updateTextViews();

        tvLineValue.setOnClickListener(this);
    ...
    public void updateTextViews() {
        ...
        tvSizeValue.setText(String.valueOf(myFontMetricsView.mTextPaint.getTextSize()));
        tvLineValue.setText(String.valueOf(myFontMetricsView.getHeight()));
    }
}
